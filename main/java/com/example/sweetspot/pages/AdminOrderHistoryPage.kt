...
@Composable
fun AdminOrderHistoryPage(
    navController: NavController
) {
    val orderHistoryViewModel: OrderHistoryViewModel = viewModel(
        factory = OrderHistoryViewModelFactory(filterByUser = false)
    )
                        ...
                        items(orders) { order ->
                            OrderItemCardAdmin(
                                ...
                                onStatusChange = { updatedOrder, newStatus ->
                                    orderHistoryViewModel.updateOrderStatus(updatedOrder, newStatus)
                                }
                            )
                        }
                    }
    ...
    Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                Text(text = "Change Status:", style = MaterialTheme.typography.bodyMedium)
